...
static ssize_t sendall(SOCKET sock, const unsigned char *buffer, size_t size);
...
ssize_t sendall(SOCKET sock, const unsigned char *buffer, size_t size)
{
    size_t sent;
    ssize_t r;
